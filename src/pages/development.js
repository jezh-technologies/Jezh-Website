...
function Development() {
  ...
  <ol class="breadcrumb p-3">
    ...
    <div class="row align-items-center">
      <div class="col-lg-8">
        <h1 class="display-3 fw-bold lh-2 text-black mb-4">Powering Your Future through our Cutting-Edge Technological Solutions</h1>
        <Getproposal/>

        
      </div>
      <div class="col-lg-4 p-0">
          <img class="rounded-lg-3 img-fluid" src="https://uploads-ssl.webflow.com/6450b8115518edb92e39a41a/64d7508843b963f3cef7ca87_Data%20extraction-amico%20(1).png" alt="" width="500"/>
      </div>
    </div>
  </div>
        </section>
