...
function Development() {
  return (
    <>
          <Head>
        <title>Jezh Technologies | Development</title>
  ...
  />
      ...
      <main className="px-lg-5 mx-lg-5 px-md-1 text-white ">
        <Navbar/>
        <nav class="text-bg-transparent text-black bg-gradient bg-white rounded rounded-top-0 rounded-bottom-2 animate__animated animate__slideInDown">
  <ol class="breadcrumb p-3">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="border border-top-0 border-start-0 border-end-0 border-secondary fw-semibold fs-5">Development</span></li>
        ...
        <section>
        <div class="container my-5 animate__animated animate__slideInDown">
