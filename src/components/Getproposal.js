...
<button class="btn btn-light p-1 btn-lg fw-bolder mt-2" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">
<span class="p-3">Get a Proposal</span>
  <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-arrow-right bg-dark text-white rounded-3 p-2 " viewBox="0 0 16 16">
